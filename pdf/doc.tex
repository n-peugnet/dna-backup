...
En son absence, les différentes données d'un support seraient toutes écrites d'un seul bloc
...
ou bien encore les permissions dans le cas d'un système POSIX.
...
Pour des supports plus spécifiques, il est assez fréquent que les systèmes de fichiers soient conçus exclusivement pour ces supports.
C'est par exemple le cas pour les bandes magnétiques avec \ac{hptfs} et \ac{ltfs} ou les 
